      ...
      {activeMenu && (<>
        <div className='flex justify-between items-center'>
          ...
          <TooltipComponent content='menu' position='BottomCenter'>            
            <button type='button' onClick={() => setActiveMenu((prevActiveMenu) => !prevActiveMenu)}  className='tect-xl rounded-full p-3 hover:bg-light-gray mt-4 block md:hidden '>
              <MdOutlineCancel />
            </button>
          </TooltipComponent>
        </div>
